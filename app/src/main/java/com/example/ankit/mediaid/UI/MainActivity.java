...
import com.example.ankit.mediaid.Fragment.Med_List;
import com.example.ankit.mediaid.Fragment.Med_billing;
import com.example.ankit.mediaid.Fragment.My_meds;
import com.example.ankit.mediaid.Fragment.Search_med;
...
import com.example.ankit.mediaid.NestedListView;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
        ...
        db.child("user").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(u!=null) {
                    ...
                    Glide.with(MainActivity.this).load(u.getImageurl()).asBitmap().into(new SimpleTarget<Bitmap>( 440, 176) {
                        @Override
                        public void onResourceReady(Bitmap resource, GlideAnimation<? super Bitmap> glideAnimation) {
                            ...
                            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
                                ...
                                headerView.findViewById(R.id.c).setBackground(drawable);
                            }
                        }
                    });
                }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        // return true so that the user_menu pop up is opened
